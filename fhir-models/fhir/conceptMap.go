...
type ConceptMapGroup struct {
	...
	Element           []ConceptMapGroupElement `bson:"element" json:"element,omitempty"`
...
type ConceptMapGroupElementTarget struct {
	...
	Code              *string                                 `bson:"code,omitempty" json:"code,omitempty"`
	Display           *string                                 `bson:"display,omitempty" json:"display,omitempty"`
	Equivalence       ConceptMapEquivalence                   `bson:"equivalence" json:"equivalence,omitempty"`
...
type ConceptMapGroupElementTargetDependsOn struct {
	...
	Extension         []Extension `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Property          string      `bson:"property" json:"property,omitempty"`
...
type ConceptMapGroupUnmapped struct {
	...
	Extension         []Extension                 `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension                 `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Mode              ConceptMapGroupUnmappedMode `bson:"mode" json:"mode,omitempty"`
	Code              *string                     `bson:"code,omitempty" json:"code,omitempty"`
	Display           *string                     `bson:"display,omitempty" json:"display,omitempty"`
	Url               *string                     `bson:"url,omitempty" json:"url,omitempty"`
}
