...
type MedicinalProductDefinition struct {
	...
	Name                           []MedicinalProductDefinitionName           `bson:"name" json:"name,omitempty"`
...
type MedicinalProductDefinitionContact struct {
	...
	ModifierExtension []Extension      `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Type              *CodeableConcept `bson:"type,omitempty" json:"type,omitempty"`
	Contact           Reference        `bson:"contact" json:"contact,omitempty"`
}
type MedicinalProductDefinitionName struct {
	Id                *string                                         `bson:"id,omitempty" json:"id,omitempty"`
	Extension         []Extension                                     `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension                                     `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	ProductName       string                                          `bson:"productName" json:"productName,omitempty"`
	Type              *CodeableConcept                                `bson:"type,omitempty" json:"type,omitempty"`
...
type MedicinalProductDefinitionNameNamePart struct {
	...
	Extension         []Extension     `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension     `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Part              string          `bson:"part" json:"part,omitempty"`
...
type MedicinalProductDefinitionNameCountryLanguage struct {
	...
	Extension         []Extension      `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension      `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Country           CodeableConcept  `bson:"country" json:"country,omitempty"`
...
type MedicinalProductDefinitionCrossReference struct {
	...
	Extension         []Extension       `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension       `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Product           CodeableReference `bson:"product" json:"product,omitempty"`
	Type              *CodeableConcept  `bson:"type,omitempty" json:"type,omitempty"`
}
