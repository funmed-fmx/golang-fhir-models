...
type GuidanceResponse struct {
	...
	ModuleUri             string                 `bson:"moduleUri" json:"moduleUri,omitempty"`
	ModuleCanonical       string                 `bson:"moduleCanonical" json:"moduleCanonical,omitempty"`
	ModuleCodeableConcept CodeableConcept        `bson:"moduleCodeableConcept" json:"moduleCodeableConcept,omitempty"`
	Status                GuidanceResponseStatus `bson:"status" json:"status,omitempty"`
