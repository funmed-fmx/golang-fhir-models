...
type AppointmentResponse struct {
	...
	Appointment       Reference           `bson:"appointment" json:"appointment,omitempty"`
	...
	ParticipantStatus ParticipationStatus `bson:"participantStatus" json:"participantStatus,omitempty"`
