...
type Claim struct {
	...
	Status               FinancialResourceStatusCodes `bson:"status" json:"status,omitempty"`
	...
	Priority             CodeableConcept              `bson:"priority" json:"priority,omitempty"`
	...
	Insurance            []ClaimInsurance             `bson:"insurance" json:"insurance,omitempty"`
