...
type Encounter struct {
	...
	Status            EncounterStatus           `bson:"status" json:"status,omitempty"`
	StatusHistory     []EncounterStatusHistory  `bson:"statusHistory,omitempty" json:"statusHistory,omitempty"`
	Class             Coding                    `bson:"class" json:"class,omitempty"`
...
type EncounterDiagnosis struct {
	...
	Extension         []Extension      `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension      `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Condition         Reference        `bson:"condition" json:"condition,omitempty"`
...
type EncounterLocation struct {
	...
	Extension         []Extension              `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension              `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Location          Reference                `bson:"location" json:"location,omitempty"`
