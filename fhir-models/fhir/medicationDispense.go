...
type MedicationDispense struct {
	...
	MedicationCodeableConcept   CodeableConcept                 `bson:"medicationCodeableConcept" json:"medicationCodeableConcept,omitempty"`
	MedicationReference         Reference                       `bson:"medicationReference" json:"medicationReference,omitempty"`
	...
	WhenPrepared                *time.Time                      `bson:"whenPrepared,omitempty" json:"whenPrepared,omitempty"`
	WhenHandedOver              *time.Time                      `bson:"whenHandedOver,omitempty" json:"whenHandedOver,omitempty"`
...
type MedicationDispensePerformer struct {
	...
	Actor             Reference        `bson:"actor" json:"actor,omitempty"`
}
type MedicationDispenseSubstitution struct {
	Id                *string           `bson:"id,omitempty" json:"id,omitempty"`
	Extension         []Extension       `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension       `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	WasSubstituted    bool              `bson:"wasSubstituted" json:"wasSubstituted,omitempty"`
	Type              *CodeableConcept  `bson:"type,omitempty" json:"type,omitempty"`
