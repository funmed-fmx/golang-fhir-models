...
type ExplanationOfBenefit struct {
	...
	Status                ExplanationOfBenefitStatus             `bson:"status" json:"status,omitempty"`
	Type                  CodeableConcept                        `bson:"type" json:"type,omitempty"`
	SubType               *CodeableConcept                       `bson:"subType,omitempty" json:"subType,omitempty"`
	Use                   Use                                    `bson:"use" json:"use,omitempty"`
	...
	Insurer               Reference                              `bson:"insurer" json:"insurer,omitempty"`
	Provider              Reference                              `bson:"provider" json:"provider,omitempty"`
	...
	Outcome               RemittanceOutcome                      `bson:"outcome" json:"outcome,omitempty"`
	...
	Insurance             []ExplanationOfBenefitInsurance        `bson:"insurance" json:"insurance,omitempty"`
...
type ExplanationOfBenefitCareTeam struct {
	...
	Extension         []Extension      `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension      `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Sequence          int              `bson:"sequence" json:"sequence,omitempty"`
	Provider          Reference        `bson:"provider" json:"provider,omitempty"`
...
type ExplanationOfBenefitSupportingInfo struct {
	...
	ModifierExtension []Extension      `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Sequence          int              `bson:"sequence" json:"sequence,omitempty"`
	Category          CodeableConcept  `bson:"category" json:"category,omitempty"`
	Code              *CodeableConcept `bson:"code,omitempty" json:"code,omitempty"`
	TimingDate        *time.Time       `bson:"timingDate,omitempty" json:"timingDate,omitempty"`
...
type ExplanationOfBenefitDiagnosis struct {
	...
	ModifierExtension        []Extension       `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Sequence                 int               `bson:"sequence" json:"sequence,omitempty"`
	DiagnosisCodeableConcept CodeableConcept   `bson:"diagnosisCodeableConcept" json:"diagnosisCodeableConcept,omitempty"`
	DiagnosisReference       Reference         `bson:"diagnosisReference" json:"diagnosisReference,omitempty"`
	Type                     []CodeableConcept `bson:"type,omitempty" json:"type,omitempty"`
...
type ExplanationOfBenefitProcedure struct {
	...
	ProcedureCodeableConcept CodeableConcept   `bson:"procedureCodeableConcept" json:"procedureCodeableConcept,omitempty"`
	ProcedureReference       Reference         `bson:"procedureReference" json:"procedureReference,omitempty"`
...
type ExplanationOfBenefitInsurance struct {
	...
	Extension         []Extension `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Focal             bool        `bson:"focal" json:"focal,omitempty"`
	Coverage          Reference   `bson:"coverage" json:"coverage,omitempty"`
	PreAuthRef        []string    `bson:"preAuthRef,omitempty" json:"preAuthRef,omitempty"`
}
...
type ExplanationOfBenefitItem struct {
	...
	ProductOrService        CodeableConcept                        `bson:"productOrService" json:"productOrService,omitempty"`
...
type ExplanationOfBenefitTotal struct {
	...
	ModifierExtension []Extension     `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Category          CodeableConcept `bson:"category" json:"category,omitempty"`
	Amount            Money           `bson:"amount" json:"amount,omitempty"`
}
