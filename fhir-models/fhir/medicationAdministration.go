...
type MedicationAdministration struct {
	...
	EffectiveDateTime         time.Time                           `bson:"effectiveDateTime" json:"effectiveDateTime,omitempty"`
	EffectivePeriod           Period                              `bson:"effectivePeriod" json:"effectivePeriod,omitempty"`
