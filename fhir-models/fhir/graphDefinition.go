...
type GraphDefinition struct {
	...
	Start             ResourceType          `bson:"start" json:"start,omitempty"`
...
type GraphDefinitionLinkTarget struct {
	...
	Extension         []Extension                            `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension                            `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Type              ResourceType                           `bson:"type" json:"type,omitempty"`
...
type GraphDefinitionLinkTargetCompartment struct {
	...
	Extension         []Extension          `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension []Extension          `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Use               GraphCompartmentUse  `bson:"use" json:"use,omitempty"`
	Code              CompartmentType      `bson:"code" json:"code,omitempty"`
	Rule              GraphCompartmentRule `bson:"rule" json:"rule,omitempty"`
