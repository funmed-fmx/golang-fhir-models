...
type ImagingStudy struct {
	...
	Status             ImagingStudyStatus   `bson:"status" json:"status,omitempty"`
...
type ImagingStudySeries struct {
	...
	Modality          Coding                        `bson:"modality" json:"modality,omitempty"`
	Description       *string                       `bson:"description,omitempty" json:"description,omitempty"`
	NumberOfInstances *int                          `bson:"numberOfInstances,omitempty" json:"numberOfInstances,omitempty"`
	Endpoint          []Reference                   `bson:"endpoint,omitempty" json:"endpoint,omitempty"`
...
type ImagingStudySeriesInstance struct {
	...
	ModifierExtension []Extension `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	Uid               string      `bson:"uid" json:"uid,omitempty"`
	SopClass          Coding      `bson:"sopClass" json:"sopClass,omitempty"`
	Number            *int        `bson:"number,omitempty" json:"number,omitempty"`
