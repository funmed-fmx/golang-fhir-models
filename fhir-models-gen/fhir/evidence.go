...
type Evidence struct {
	...
	VariableDefinition []EvidenceVariableDefinition `bson:"variableDefinition,omitempty" json:"variableDefinition,omitempty"`
...
type EvidenceVariableDefinition struct {
	...
	Description       *string          `bson:"description,omitempty" json:"description,omitempty"`
	Note              []Annotation     `bson:"note,omitempty" json:"note,omitempty"`
	VariableRole      CodeableConcept  `bson:"variableRole,omitempty" json:"variableRole,omitempty"`
...
type EvidenceStatisticModelCharacteristicVariable struct {
	...
	Extension          []Extension               `bson:"extension,omitempty" json:"extension,omitempty"`
	ModifierExtension  []Extension               `bson:"modifierExtension,omitempty" json:"modifierExtension,omitempty"`
	VariableDefinition Reference                 `bson:"variableDefinition,omitempty" json:"variableDefinition,omitempty"`
