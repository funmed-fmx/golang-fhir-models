...
type CitationRelatesTo struct {
	...
	TargetAttachment  Attachment        `bson:"targetAttachment,omitempty" json:"targetAttachment,omitempty"`
}
type CitationCitedArtifact struct {
	...
	DateAccessed      *time.Time                             `bson:"dateAccessed,omitempty" json:"dateAccessed,omitempty"`
...
type CitationCitedArtifactPublicationForm struct {
	...
	ArticleDate       *time.Time                                           `bson:"articleDate,omitempty" json:"articleDate,omitempty"`
